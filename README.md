# raymond [![Build Status](https://secure.travis-ci.org/aymerick/raymond.svg?branch=master)](http://travis-ci.org/aymerick/raymond) [![GoDoc](https://godoc.org/github.com/charl/raymond?status.svg)](http://godoc.org/github.com/charl/raymond)

Handlebars for [golang](https://golang.org) with the same features as [handlebars.js](http://handlebarsjs.com) `3.0`.

The full API documentation is available here: <http://godoc.org/github.com/charl/raymond>.

![Raymond Logo](https://github.com/charl/raymond/blob/master/raymond.png?raw=true "Raymond")
...
## Quick Start
    ...
    $ go get github.com/charl/raymond
...
import (
    ...
    "github.com/charl/raymond/lexer"
)
...
import (
    ...
    "github.com/charl/raymond/ast"
    "github.com/charl/raymond/parser"
)
